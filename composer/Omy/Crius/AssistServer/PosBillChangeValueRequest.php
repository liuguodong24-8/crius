...
/**
 * PosBillChangeValueRequest 账单金额改变
 *
 * Generated from protobuf message <code>assist.PosBillChangeValueRequest</code>
 */
class PosBillChangeValueRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * 咨客账单信息
     *
