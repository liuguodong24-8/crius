...
/**
 * Generated from protobuf message <code>memberExtension.DistributeCoupon.ValidTimeInterval</code>
 */
...
class_alias(ValidTimeInterval::class, \Omy\Crius\ExtensionServer\DistributeCoupon_ValidTimeInterval::class);
