...
/**
 * MemberGainPointByRuleRequest 通过规则获取积分
 *
 * Generated from protobuf message <code>memberExtension.MemberGainPointByRuleRequest</code>
 */
class MemberGainPointByRuleRequest extends \Google\Protobuf\Internal\Message
{
    /**
